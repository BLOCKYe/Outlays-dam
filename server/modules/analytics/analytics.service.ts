...
export default class AnalyticsService {
  private readonly analyticsServices: AnalyticsRepository;

  constructor() {
    this.analyticsServices = new AnalyticsRepository();
  }
  ...
  public async spentAmount(req: NextApiRequest, res: NextApiResponse) {
    try {
      ...
      const spentAmount: any = await this.analyticsServices.getSpentAmount(
        payload.userId
      );
